"""
Django settings for cold_sky_39145 project.
...
ROOT_URLCONF = 'cold_sky_39145.urls'
...
WSGI_APPLICATION = 'cold_sky_39145.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_sky_39145 API",
    "DESCRIPTION": "API documentation for cold_sky_39145 App",
    "VERSION": "v1",
}
